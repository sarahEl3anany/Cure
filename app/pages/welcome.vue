    ...
    <div class="space-y-5 mt-12">
      <div class="mx-8 xs:w-64 sm:w-64 md:w-64 lg:w-96">
        <Button class="h-12 w-full border-neutral-300 rounded-lg bg-white">
          ...
          <span class="text-base text-neutral-700 font-montserratMedium">
            Sign in with Facebook
          </span>
        </Button>
      </div>
      <div class="mx-8 xs:w-64 sm:w-64 md:w-64 lg:w-96">
        <GoogleSignIn classStyle="text-base text-neutral-700 font-montserratMedium h-12 w-full border-neutral-300 rounded-lg bg-white" 
